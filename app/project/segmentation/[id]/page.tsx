...
const Segmentation = dynamic(() => import('../../../components/Segmentation'), { ssr: false });

export default function MainSeg( {params} ) {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 p-4">
        {content === 'main' && (
          <>
            <h1 className="text-3xl font-bold">Welcome to the Main Content of Segmentation</h1>
            <p className="mt-4">
        ...
        {content === 'upload' && <ImageUploader idproject={params.id} type="segmentation" />}
        {content === 'annotate' && <Segmentation idproject={params.id} />}
      </main>
    </div>
  );
}