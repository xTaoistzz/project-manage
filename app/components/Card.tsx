...
const Card = ({ data }) => {
    ...
    const handleSegmentation = () => {
        router.push(`/project/segmentation/${data.idproject}`)
    }
    return (
        <div className="card bg-white shadow-md rounded-lg p-4">
            ...
            <div className="flex flex-col">
                <div className="grid grid-cols-1 gap-2">
                    ...
                    <button className=" bg-gray-500 text-white font-bold py-2 px-4 rounded" onClick={handleSegmentation}>Segmentation</button>
                </div>
